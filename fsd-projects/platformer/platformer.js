document.addEventListener("DOMContentLoaded", function () {
  ...
  function setup() {
    ...
    createBadPlatform(260, 700, 300, 20, "red");

    createBadPlatform(850, 700, 300, 20, "red");
    ...
    // 1 - starting platform
    createCollectable("steve", 120, 560, 0, 1);

    // 2 - second platform
    createCollectable("kennedi", 350, 490, 0, 1);

    // 3 - third platform
    createCollectable("max", 600, 400, 0, 1);

    // 4 - high platform
    createCollectable("grace", 850, 310, 0, 1);

    // 5 - right platform
    createCollectable("max", 1080, 420, 0, 1);

    // 6 - final high platform
    createCollectable("database", 1260, 250, 0, 1);

    // 7 - lower middle platform
    createCollectable("diamond", 700, 600, 0, 1);

    // 8 - another final collectable
    createCollectable("steve", 1340, 250, 0, 1);
    ...
    // Cannon 1
    // Left side
    createCannon("left", 350, 1300);

    // Cannon 2
    // Lower left
    createCannon("left", 580, 1700);
    ...
    createCannon("right", 520, 1100);

    // Cannon 5
    // Top - shoots downward
    createCannon("top", 600, 1700);
